...
class CMP_Stop(models.Model):
    ...
    def cmp_single_node_to_xml(self, is_present, version_inc, name):
        outputparams = {
            'newline': '',
            'indent': '',
            'upload': 'True',
        ...
        xml = ''
        xml += self.fixed_match.single_node_to_xml(version_inc=version_inc, outputparams=outputparams, name=name)
